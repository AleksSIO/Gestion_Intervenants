...
class Controleur {
	...
	public function selectWhereAll($where, $chaine = "*") {
    	return $this->unModele->selectWhereAll($where, $chaine);
    }
	...
	public function getIdSalle() {
		return $this->unModele->getIdSalle();
	}

	public function getIdInterventions() {
		return $this->unModele->getIdInterventions();
	}
	...
	public function selectAllSalles($depart, $sallesParPage) {
		return $this->unModele->selectAllSalles($depart, $sallesParPage);
	}

	public function selectAllInterventions($depart, $interventionsParPage) {
		return $this->unModele->selectAllInterventions($depart, $interventionsParPage);
	}
